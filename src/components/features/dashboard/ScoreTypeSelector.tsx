    ...
    <div className="grid grid-cols-2 gap-4 px-1">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center gap-5">
          {/* 🚨 脱・グラスモーフィズム: 屋外視認性を高めるため `backdrop-blur-md` を外し、ソリッドな白透過（bg-white/30）へ変更 */}
          <div className="p-4 bg-white/30 rounded-2xl border border-white/20 shadow-inner">
