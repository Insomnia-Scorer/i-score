        ...
        <div className="p-6 md:p-10 rounded-[32px] bg-card/40 backdrop-blur-xl border border-border/50 shadow-sm space-y-10 leading-relaxed">
          ...
          <section className="space-y-4">
            <p className="text-muted-foreground">
              この利用規約（以下、「本規約」といいます。）は、iS Baseball Lab（以下、「当ラボ」といいます。）が提供するアプリケーション「iScore」（以下、「本サービス」といいます。）の利用条件を定めるものです。ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
            </p>
          </section>
