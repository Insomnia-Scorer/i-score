...
function PlayerDetailContent() {
    ...
    if (!playerName) return <div className="flex h-screen items-center justify-center font-bold text-muted-foreground">選手情報が指定されていません</div>;
            ...
            <main className="flex-1 px-4 sm:px-6 max-w-5xl mx-auto w-full space-y-8 mt-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-primary/80 text-primary-foreground rounded-[32px] p-6 sm:p-10 shadow-lg shadow-primary/20 border border-primary/20 group">
                    ...
                    <div className="flex flex-col sm:flex-row items-center sm:items-end gap-6 relative z-10">
                        ...
                        <div className="w-28 h-28 sm:w-36 sm:h-36 rounded-[28px] bg-white/10 backdrop-blur-xl border border-white/20 flex flex-col items-center justify-center shrink-0 overflow-hidden text-white/60 relative shadow-inner">
                            ...
                            <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 hover:opacity-100 transition-all duration-300 cursor-pointer backdrop-blur-sm">
                                <Camera className="h-8 w-8 text-white drop-shadow-md" />
                            </div>
                        </div>

                        <div className="space-y-3 text-center sm:text-left">
                            <div className="inline-flex items-center rounded-full px-3 py-1 text-[10px] sm:text-xs font-black bg-white/20 text-white uppercase tracking-[0.2em] border border-white/10 backdrop-blur-sm shadow-sm">
                                2026 Season
                            </div>
                            <div className="flex items-baseline justify-center sm:justify-start gap-3 sm:gap-4">
                                ...
                                <span className="text-3xl sm:text-4xl lg:text-5xl font-black text-white/50 drop-shadow-sm leading-none">
                                    #{uniformNumber}
                                </span>
                            </div>
                        </div>
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                    <div className="space-y-6">
                        {/* 💡 究極UI: 打撃成績（Apple Fitnessのような美しい指標ブロック） */}
                        <Card className="rounded-[32px] border-border/50 bg-background shadow-xs overflow-hidden transition-all duration-300 hover:shadow-md hover:border-primary/30">
                        ...
                        {/* 💡 究極UI: 投手成績 */}
                        <Card className="rounded-[32px] border-border/50 bg-background shadow-xs overflow-hidden transition-all duration-300 hover:shadow-md hover:border-blue-500/30">
                            <div className="bg-muted/30 p-5 sm:p-6 border-b border-border/50">
                                <h2 className="text-xl font-black tracking-tight flex items-center gap-2.5 text-foreground">
                            ...
                            <CardContent className="p-6 flex-1 flex flex-col justify-center">
                                {sprayData.length === 0 ? (
                                    ...
                                    <>
                                        ...
                                        <div className="flex items-center justify-center gap-5 mt-8 text-xs font-extrabold text-muted-foreground bg-muted/30 py-3.5 rounded-[16px] border border-border/50">
                                            ...
                                            <div className="flex items-center gap-2"><div className="w-3.5 h-3.5 rounded-full bg-[#f97316] border border-white shadow-sm"></div>本塁打</div>
