                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
                        {players.map((player) => (
                            <Card key={player.id} className="relative overflow-hidden group border-border/60 bg-gradient-to-br from-background via-background to-muted/30 hover:border-primary/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-1.5 rounded-2xl">
                                <div className="absolute -bottom-12 -right-6 text-[180px] sm:-bottom-16 sm:-right-8 sm:text-[220px] font-black italic text-foreground/5 group-hover:text-primary/10 transition-colors select-none z-0 tracking-tighter leading-none">{player.uniformNumber}</div>
