                    ...
                    <CardContent className="p-5 sm:p-6 relative z-10">
                        ...
                        <form onSubmit={handleAddPlayer} className="flex flex-col sm:flex-row items-end gap-4">
                            <div className="w-full sm:w-32 space-y-2">
                                {/* 💡 修正: text-sm sm:text-base にサイズアップ */}
                                <label className="block text-sm sm:text-base font-bold text-muted-foreground uppercase tracking-widest pl-1">背番号</label>
                            ...
                            <div className="w-full flex-1 space-y-2">
                                {/* 💡 修正: text-sm sm:text-base にサイズアップ */}
                                <label className="block text-sm sm:text-base font-bold text-muted-foreground uppercase tracking-widest pl-1">選手名</label>
